"""Dan's solutions for https://adventofcode.com/"""
import logging
import runpy
import subprocess
import sys
...
def run_one():
    ...
    mod_name = f"aoc_dan.aoc{args.year}.q{args.day:02d}"
...
def speedhack():
    ...
    args = ["aoc", "-y", str(year), "-d", str(day), "-u", "github.ddugovic.144571", "-r", "--log-level", "DEBUG"]
    print("\n" + " ".join(args))
    subprocess.check_call(args)
